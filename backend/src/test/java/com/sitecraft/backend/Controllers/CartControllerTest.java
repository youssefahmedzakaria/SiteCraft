...
public class CartControllerTest {
    ...
    void testAddProductToCart_Unauthorized() throws Exception {
        ...
        verify(cartService, never()).addProductToCart(anyLong(), anyLong(), anyString(), anyInt());
    }

    @Test
    void testAddProductToCart_ServiceReturnsNull() throws Exception {
        // Arrange
        AddCartProductRequest request = new AddCartProductRequest();
        request.productId = 1L;
        request.sku = "TEST-SKU-001";
        ...
        verify(cartService).addProductToCart(1L, 1L, "TEST-SKU-001", 3);
        verify(cartService, never()).createCartProductDTO(any());
    }

    @Test
    void testAddProductToCart_DTOCreationFails() throws Exception {
        // Arrange
        AddCartProductRequest request = new AddCartProductRequest();
        request.productId = 1L;
        request.sku = "TEST-SKU-001";
        ...
        when(cartService.addProductToCart(1L, 1L, "TEST-SKU-001", 3)).thenReturn(cartProduct);
        when(cartService.createCartProductDTO(cartProduct)).thenReturn(null);
    ...
    @Test
    void testAddProductToCart_ServiceException() throws Exception {
        // Arrange
        AddCartProductRequest request = new AddCartProductRequest();
        request.productId = 1L;
        request.sku = "TEST-SKU-001";
        ...
        when(cartService.addProductToCart(1L, 1L, "TEST-SKU-001", 3))
    ...
    void testRemoveProductFromCart_Unauthorized() throws Exception {
        ...
        verify(cartService, never()).removeProductFromCart(anyLong(), anyLong());
    }

    @Test
    void testRemoveProductFromCart_ServiceReturnsFalse() throws Exception {
        // Arrange
    ...
    void testUpdateProductQuantity_Unauthorized() throws Exception {
        ...
        verify(cartService, never()).updateProductQuantity(anyLong(), anyLong(), anyInt());
    }

    @Test
    void testUpdateProductQuantity_ServiceReturnsFalse() throws Exception {
        // Arrange
        UpdateCartProductRequest request = new UpdateCartProductRequest();
        request.cartProductId = 1L;
        request.quantity = 5;
