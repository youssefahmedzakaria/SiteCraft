...
public class Product {
    ...
    public Product(Long id, String name, String description, String discountType, Double discountValue, Double minCap, Double percentageMax, Double maxCap, Category category, Store store) {
        this.id = id;
        this.name = name;
    ...
    public void setPercentageMax(Double percentageMax) {
        this.percentageMax = percentageMax;
    }
