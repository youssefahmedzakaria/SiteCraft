...
export function PromoSlide({
  ...
  const variants = {
    centered: {
      ...
      content:
        "absolute inset-0 flex flex-col items-center justify-center text-center p-6 md:p-12 bg-black/50 text-white z-10",
      image: "absolute inset-0 w-full h-full",
    },
    overlay: {
      container: "relative h-[500px]",
      content:
        "absolute inset-0 flex flex-col justify-center p-6 md:p-12 bg-gradient-to-r from-black/80 to-transparent text-white z-10",
      image: "absolute inset-0 w-full h-full",
    },
    minimalRight: {
      container: "relative h-[500px]",
      content:
        "absolute bottom-0 left-0 right-0 p-6 md:p-12 bg-gradient-to-t from-black/80 to-transparent text-white z-10 text-right",
      image: "absolute inset-0 w-full h-full",
    },
    minimalLeft: {
      container: "relative h-[500px]",
      content:
        "absolute bottom-0 left-0 right-0 p-6 md:p-12 bg-gradient-to-t from-black/80 to-transparent text-white z-10",
