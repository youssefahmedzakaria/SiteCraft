...
export const NavbarTemplate6: React.FC<NavbarTemplate6Props> = ({
  ...
  const isMobileDiv =
    isCustomize && navbarSize.width > 0 && navbarSize.width < 768;
  ...
  const shouldShowMobile = isCustomize
    ? isMobileDiv || isScreenMobile
    : isScreenMobile;

  // Filter visible menu items
  const visibleMenuItems =
    menuItems?.filter((item) => item.isShown !== false) || [];
  ...
  return (
    <>
      ...
      <nav
        ...
        } top-0 left-0 w-full z-30 backdrop-blur ${fontFamily}`}
        style={{
            ...
            <div className="relative flex items-center justify-between h-16 w-full">
              ...
              <div className="flex-shrink-0 flex items-center space-x-6">
                ...
                <div className="flex items-center space-x-6">
                  <Link
                    href={
                      isCustomize ? "#" : `/e-commerce/${subdomain}/profile`
                    }
                  ...
                  <Link
                    href={
                      isCustomize ? "#" : `/e-commerce/${subdomain}/favorites`
                    }
                    className="text-sm hover:underline transition-all"
                    style={{
                      color: textColor.includes("[")
