        ...
        {featuredCategory && (
          ...
          >
            <div className={cn("relative h-96 md:h-full bg-slate-100 overflow-hidden w-full", borderRadius)}>
              <Image
                src={featuredCategory.media?.mainMedia?.image?.url || "/placeholder.svg?height=600&width=800"}
              ...
              />
              {showCategoryTitle && (
                <div className={cn("absolute inset-0 flex items-end", overlayGradientClass)}>
                  <div className="p-6">
                    <h3 className="text-white text-2xl font-bold">{featuredCategory.name}</h3>
