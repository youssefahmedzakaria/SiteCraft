  ...
  return (
    <div className={cn("w-full", bgColor)}>
      <div className={cn("mx-auto px-16 py-8 md:py-16", textColor, fontFamily)}>
        {showTitle && (
          <h2 className={cn("text-4xl md:text-4xl font-bold text-center mb-6", titleColor, titleFontSize, titleFont)}>
            {title}
          </h2>
        )}

        <div className={cn("grid grid-cols-1 md:grid-cols-3 w-full h-full", gap)}>
          ...
          {featuredCategory && (
            <div className="md:col-span-2 md:row-span-2 w-full h-full">
              <FlexibleCard
                ...
                linkPath={isClickable ? `/e-commerce/${subdomain}/products` : undefined}
