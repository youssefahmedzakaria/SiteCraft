                  ...
                  <div className="p-6">
                    ...
                    >
                      ...
                      {(() => {
                        ...
                        if (
                          featuredProduct.discountType &&
                          typeof featuredProduct.discountValue === "number"
                        ) {
                          if (featuredProduct.discountType === "percentage") {
                            currentPrice =
                              originalPrice -
                              (originalPrice * featuredProduct.discountValue) /
                                100;
                            discountPercent = featuredProduct.discountValue;
                          } else if (
                            featuredProduct.discountType === "fixed amount"
                          ) {
                            currentPrice =
                              originalPrice - featuredProduct.discountValue;
                            discountPercent = Math.round(
                              (featuredProduct.discountValue / originalPrice) *
                                100
                            );
                          }
                        }
                      ...
                      return (
                        <>
                          <div className="flex items-center gap-2 mt-2">
                            <span
                              className={cn("font-semibold", cardTextColor)}
                            >
                    ...
                    {showCta && (
                      <p className={cn(cardTextColor, "mt-2")}>{ctaText}</p>
                    )}
                  </div>
                </div>
              </div>
                  ...
                  >
                    ...
                    >
                      <div className="p-4">
                          ...
                          {product.discountType &&
                            ...
                            (() => {
                              ...
                              if (product.discountType === "percentage") {
                                ...
                                product.discountType === "fixed amount"
                              ) {
                                currentPrice =
                        ...
                        {showCta && (
                          <p className={cn(cardTextColor, "text-sm mt-1")}>
                            {ctaText}
                          </p>
                        )}
                      </div>
