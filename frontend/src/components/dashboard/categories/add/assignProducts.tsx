          ...
          <div className="overflow-x-auto">
            <table className="w-full table-fixed border-collapse">
              <thead className="bg-logo-light-button">
                <tr>
                  <th className="w-1/6 px-4 py-3 text-left text-xs font-medium text-logo-txt uppercase tracking-wider">
                    ID
                  </th>
                  <th className="w-2/6 px-4 py-3 text-left text-xs font-medium text-logo-txt uppercase tracking-wider">
                    Name
                  </th>
                  <th className="w-1/6 px-4 py-3 text-left text-xs font-medium text-logo-txt uppercase tracking-wider">
                    Category
                  ...
                  <th className="w-1/6 px-4 py-3 text-center text-xs font-medium text-logo-txt uppercase tracking-wider">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                {assignedProducts.map((product) => (
                  <tr key={product.id}>
                    <td className="w-1/6 px-4 py-3 text-sm text-gray-900 truncate text-left">
                      {product.id}
                    </td>
            ...
            <div className="my-4 max-h-96 overflow-y-auto">
              <table className="w-full table-fixed border-collapse">
                <thead className="bg-logo-light-button sticky top-0">
                  <tr>
                    <th className="w-1/12 px-4 py-3 text-left text-xs font-medium text-logo-txt uppercase tracking-wider">
                      Select
                    </th>
                    <th className="w-5/12 px-4 py-3 text-left text-xs font-medium text-logo-txt uppercase tracking-wider">
                      Name
                    </th>
                    <th className="w-3/12 px-4 py-3 text-left text-xs font-medium text-logo-txt uppercase tracking-wider">
                      Category
                    </th>
                    <th className="w-3/12 px-4 py-3 text-left text-xs font-medium text-logo-txt uppercase tracking-wider">
                      Price
