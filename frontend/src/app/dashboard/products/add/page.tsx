...
export default function AddProductPage() {
    ...
    const [customVariations, setCustomVariations] = useState<{name: string, values: string[]}[]>([]);
    ...
    const handleAddVariation = (e: React.MouseEvent) => {
        e.preventDefault();
        setCustomVariations([...customVariations, {name: "New Variation", values: ['']}]);
    };
        ...
        <Card className="flex flex-col gap-4 bg-white">
            ...
            <form className="space-y-6">
                ...
                {activeTab === "Stock Management" && (
                    <>
                        <div className="mb-2">
                            <CardTitle className="font-bold text-2xl">Handle Stock Levels</CardTitle>
                            <p className="text-gray-500">Management of stock levels of different options and variation.</p>
                        </div>
