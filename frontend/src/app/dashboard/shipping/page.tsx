            ...
            <main className="flex-1 p-4 md:p-6 lg:ml-80 pt-20 md:pt-20 lg:pt-6 bg-gray-100">
                ...
                <div className="mt-10 bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <p className="text-gray-600 mb-4">
                        Configure shipping rates for different governorates. Set competitive pricing and accurate
                        delivery timeframes to enhance customer experience.
                    </p>
                    <div className="flex flex-col gap-4 mt-6">
                        <div className="flex items-start gap-3">
                            <div className="mt-1">
                                <svg className="h-5 w-5 text-logo-dark-button" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <div>
                                <p className="text-sm font-medium">Delivery Times</p>
                                <p className="text-sm text-gray-500">Estimated delivery times are displayed to customers during checkout.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            <div className="mt-1">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">All shipping prices are automatically added to order totals.</p>
                            </div>
                        </div>
                    </div>
                </div>
