...
import { SizeVariationSection } from "@/components/SiteCraft/dashboard/products/add/sizeVariationSection";
import { ColorVariationSection } from "@/components/SiteCraft/dashboard/products/add/colorVariationSection";
