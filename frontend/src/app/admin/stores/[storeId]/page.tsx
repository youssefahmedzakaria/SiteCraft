...
export default function StoreDetailsPage({
  ...
  useEffect(() => {
    setLoading(true);
    setError("");
    fetch(`http://localhost:8080/api/admin/stores/${storeId}/stats`, {
      credentials: "include",
    })
      .then((res) => {
  ...
  const handleSendMail = async () => {
    ...
    try {
      const res = await fetch(
        `http://localhost:8080/api/admin/stores/${storeId}/send-mail`,
        {
          method: "POST",
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold">
                    EGP {stats.totalSales.toLocaleString()}
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-lg shadow-sm p-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500 mt-2">
                    ...
                    <span className="font-bold">
                      EGP {stats.lastMonthSales.toLocaleString()}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded flex items-center gap-3 justify-between">
                ...
                <Button
                  ...
                  onClick={() => openMailDialog("Advice", stats.advice)}
                >
                  <Mail className="h-4 w-4" /> Notify
                </Button>
              </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700 text-sm">
                      Send a custom message to the business owner.
                    </div>
                  </div>
                </div>
                <Button
              ...
              <DialogContent>
                ...
                <div className="mb-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setMailDialog((d) => ({ ...d, subject: e.target.value }))
                    }
                    placeholder="Subject"
                    rows={1}
                  />
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setMailDialog((d) => ({ ...d, message: e.target.value }))
                    }
                ...
                <div className="flex gap-2 justify-end mt-4">
                  <Button
                    ...
                    disabled={
                      mailSending || !mailDialog.subject || !mailDialog.message
                    }
                  >
